...
namespace AssemblyBrowserTests
{
    public class Tests
    {
        ...
        public void AssemblyBrowserTests_Contains_TestClasses()
        {
            ...
            bool containsITestInterface = GetTypeNum(informator, typeof(ITestInterface)) < typesNum;
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(containsITestInterface, "ITestInterface must be in AssemblyBrowserTests namespace");
            });
        }
        [Test]
